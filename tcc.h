...
# endif
    ...
    /* discovery mode for TccLua FFI */
    int discovery_mode;
    void *discovery_userdata;
    void (*on_discovery_sym)(struct TCCState *s, const char *name, struct Sym *sym);
    /* enum constant discovery for TccLua FFI */
    void (*on_discovery_enum)(struct TCCState *s, const char *name, long long value);
};
